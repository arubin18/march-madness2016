### arranging data so that the higher seed is the first team in the data frame
...
arrange <- function(data) {
  ...
  for (i in 1:nrow(data)) {
    ...
    if (seed1 == seed2) {
      ...
      m = cbind(m, teams) # merge both matchup and teams
      m = cbind(m, w) # add the won response at the end
    }
